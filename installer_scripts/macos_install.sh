...
# curl flags
PHOENIX_INSTALL_CURL_FLAGS='--cert-status --doh-cert-status --no-insecure --no-proxy-insecure --no-sessionid --no-ssl --no-ssl-allow-beast --no-ssl-auto-client-cert --no-ssl-no-revoke --no-ssl-revoke-best-effort --proto -all,https --proto-default https --proto-redir -all,https --show-error'
...
"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchAgents/dev.celenity.phoenix.env.MOZ_CRASHREPORTER.plist || error_fn
echo
...
"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchAgents/dev.celenity.phoenix.env.MOZ_CRASHREPORTER_DISABLE.plist || error_fn
echo
...
"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchAgents/dev.celenity.phoenix.env.MOZ_CRASHREPORTER_NO_REPORT.plist || error_fn
echo
...
"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchAgents/dev.celenity.phoenix.env.MOZ_CRASHREPORTER_URL.plist || error_fn
echo
...
"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchAgents/dev.celenity.phoenix.env.MOZ_DISABLE_ASAN_REPORTER.plist || error_fn
echo
...
"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchAgents/dev.celenity.phoenix.env.SSLKEYLOGFILE.plist || error_fn
echo
...
case ${DEVICETYPE} in
	"apple" | "Apple" | "APPLE" | "silicon" | "Silicon" | "SILICON" | 1)
		...
		"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/celenity/Phoenix/phoenix-apply.sh || error_fn
		echo
		...
		"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos/Library/LaunchDaemons/dev.celenity.phoenix.apply.plist || error_fn
		echo
	...
	"intel" | "Intel" | "INTEL" | 2)
		...
		"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos-intel/Library/celenity/Phoenix/phoenix-apply-intel.sh || error_fn
		echo
		...
		"${PHOENIX_INSTALL_CURL}" https://gitlab.com/celenityy/Phoenix/-/raw/pages/macos-intel/Library/LaunchDaemons/dev.celenity.phoenix.apply.intel.plist || error_fn
		echo
