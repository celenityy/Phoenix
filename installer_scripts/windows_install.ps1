$mozillaCfgUrl = "https://phoenix.celenity.dev/phoenix.cfg"
$localSettingsJsUrl = "https://phoenix.celenity.dev/defaults/pref/local-settings.js"
$mozillaCfgPath = "C:\Program Files\Mozilla Firefox\phoenix.cfg"
$localSettingsJsPath = "C:\Program Files\Mozilla Firefox\defaults\pref\phoenix.js"
...
choco install phoenix-policies
