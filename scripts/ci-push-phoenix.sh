...
function create_release_notes() {
  ...
  local readonly PHOENIX_ANDROID_JS_SHA512SUM=$("${PHOENIX_SHA512SUM}" "${PHOENIX_ARTIFACTS}/android/phoenix-${PHOENIX_VERSION}-android.js" | "${PHOENIX_AWK}" '{print $1}')
  ...
  local readonly PHOENIX_EXTENDED_ANDROID_JS_SHA512SUM=$("${PHOENIX_SHA512SUM}" "${PHOENIX_ARTIFACTS}/android/phoenix-extended-${PHOENIX_VERSION}-android.js" | "${PHOENIX_AWK}" '{print $1}')
  ...
  local readonly PHOENIX_UNIVERSAL_CFG_SHA512SUM=$("${PHOENIX_SHA512SUM}" "${PHOENIX_ARTIFACTS}/universal/phoenix-${PHOENIX_VERSION}-universal.cfg" | "${PHOENIX_AWK}" '{print $1}')
