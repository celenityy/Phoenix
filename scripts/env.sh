...
function setup_path() {
  ...
  "${PHOENIX_LN}" -sf "${PHOENIX_SHA1SUM}" "${PHOENIX_PATH}/sha1sum"
  "${PHOENIX_LN}" -sf "${PHOENIX_SHA256SUM}" "${PHOENIX_PATH}/sha256sum"
  "${PHOENIX_LN}" -sf "${PHOENIX_SHA512SUM}" "${PHOENIX_PATH}/sha512sum"
