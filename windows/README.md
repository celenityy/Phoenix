...
**<details><summary>Photopea</summary>**
...
```sh
/etc/firefox/phoenix/userjs/photopea/user.js
```

**Flatpak**:

```sh
/var/lib/flatpak/app/org.mozilla.firefox/current/active/files/etc/firefox/phoenix/userjs/photopea/user.js
```
...
```sh
/opt/homebrew/opt/phoenix-osx/userjs/photopea/user.js
```

**Intel**:

```sh
/usr/local/opt/phoenix-osx/userjs/photopea/user.js
```
...
**<details><summary>Photopea (Firefox-UI-Fix)</summary>**
...
```sh
/etc/firefox/phoenix/userjs/ui-fix/photopea/user.js
```

**Flatpak**:

```sh
/var/lib/flatpak/app/org.mozilla.firefox/current/active/files/etc/firefox/phoenix/userjs/ui-fix/photopea/user.js
```
...
```sh
/opt/homebrew/opt/phoenix-osx/userjs/ui-fix/photopea/user.js
```

**Intel**:

```sh
/usr/local/opt/phoenix-osx/userjs/ui-fix/photopea/user.js
```
