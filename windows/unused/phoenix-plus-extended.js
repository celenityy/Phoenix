...
pref("distribution.about", "Phoenix for Mozilla Firefox - 2026.02.23.1 💜", locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] `about:preferences#general` -> `Firefox Updates` - `distribution.id` and `distribution.version` must be set for this to display, see details below
...
pref("distribution.about", "Phoenix - Extended for Mozilla Firefox: 2026.02.23.1 💜", locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
