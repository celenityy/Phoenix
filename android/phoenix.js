...
pref("app.normandy.api_url", "", locked); // [HIDDEN]
...
pref("toolkit.crashreporter.include_context_heap", false, locked); // [DEFAULT] - Defense in depth
...
pref("toolkit.coverage.enabled", false, locked); // [HIDDEN - DEFAULT]
pref("toolkit.coverage.endpoint.base", "", locked); // [HIDDEN]
...
pref("datareporting.policy.dataSubmissionPolicyAccepted", false, locked); // [HIDDEN]
...
pref("network.jar.record_failure_reason", false, locked); // [DEFAULT] - https://searchfox.org/mozilla-release/source/modules/libpref/init/StaticPrefList.yaml#14397
pref("network.traffic_analyzer.enabled", false, locked); // https://searchfox.org/mozilla-release/source/modules/libpref/init/StaticPrefList.yaml#13298
pref("network.trr.confirmation_telemetry_enabled", false, locked);
pref("nimbus.telemetry.targetingContextEnabled", false, locked); // [HIDDEN] https://searchfox.org/mozilla-central/source/browser/app/profile/firefox.js#2001
pref("privacy.imageInputTelemetry.enableTestMode", false, locked); // [DEFAULT] "Event Telemetry" https://searchfox.org/mozilla-central/source/modules/libpref/init/StaticPrefList.yaml#15549
pref("privacy.trackingprotection.emailtracking.data_collection.enabled", false, locked);
pref("toolkit.content-background-hang-monitor.disabled", true, locked);
pref("toolkit.telemetry.archive.enabled", false, locked); // [HIDDEN]
pref("toolkit.telemetry.bhrPing.enabled", false, locked); // [HIDDEN]
...
pref("toolkit.telemetry.shutdownPingSender.backgroundtask.enabled", false, locked); // [HIDDEN]
pref("toolkit.telemetry.shutdownPingSender.enabled", false, locked); // [HIDDEN]
pref("toolkit.telemetry.shutdownPingSender.enabledFirstSession", false, locked); // [HIDDEN]
pref("toolkit.telemetry.testing.suppressPingsender", true, locked); // [HIDDEN]
pref("toolkit.telemetry.translations.logLevel", "Off", locked);
pref("toolkit.telemetry.unified", false, locked); // [DEFAULT]
