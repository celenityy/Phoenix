...
* `phoenix-only-osx.json` - These policies should **ONLY** be set for macOS, but **NOT** for Thunderbird.
* `phoenix-windows-unified.json` - These policies should **ONLY** be set for Windows.
* `phoenix-only-windows.json` - These policies should **ONLY** be set for Windows, but **NOT** for Thunderbird.
