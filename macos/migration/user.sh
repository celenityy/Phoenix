...
echo_green_text "Welcome to the Phoenix (User) migration script for macOS!"
...
## Prepare Phoenix
echo_green_text "Removing the legacy 'phoenix-osx-user' package..."
brew remove -v phoenix-osx-user || error_fn
echo

echo_green_text "Removing the legacy 'phoenix.cfg'..."
/bin/rm -f ~/Applications/Firefox.app/Contents/Resources/phoenix.cfg || error_fn
echo

echo_green_text "Removing the legacy 'phoenix-desktop.js'..."
/bin/rm -f ~/Applications/Firefox.app/Contents/Resources/defaults/pref/phoenix-desktop.js || error_fn
echo

echo_green_text "Removing the legacy 'policies.json'..."
/bin/rm -f ~/Applications/Firefox.app/Contents/Resources/distribution/policies.json || error_fn
echo
