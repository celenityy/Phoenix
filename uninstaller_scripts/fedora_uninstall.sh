...
echo_green_text "Removing `phoenix-desktop.js` from `/usr/lib64/firefox` if present..."
sudo rm -f /usr/lib64/firefox/defaults/pref/phoenix-desktop.js || error_fn
echo
...
echo_green_text "Removing legacy `phoenix.js` from `/usr/lib64/firefox` if present..."
sudo rm -f /usr/lib64/firefox/defaults/pref/phoenix.js || error_fn
echo

echo_green_text "Removing `policies.json` from `/usr/lib64/firefox` if present..."
sudo rm -f /usr/lib64/firefox/distribution/policies.json || error_fn
echo
