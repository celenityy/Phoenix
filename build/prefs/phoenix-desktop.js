...
// Cloudflare (cloudflare.com) - Blocks canvas data extraction before user input (+CanvasExtractionBeforeUserInputIsBlocked), to prevent it from prompting users despite not needing the permission..., + enables timezone spoofing (+JSDateTimeUTC) as it doesn't need access
