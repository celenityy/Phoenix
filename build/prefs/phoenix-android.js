...
// Cloudflare (cloudflare.com) - Blocks (randomized) canvas data extraction before user input (+CanvasExtractionBeforeUserInputIsBlocked & +CanvasImageExtractionPrompt), as it doesn't need access and attempts to prompt users for it on desktop...
...
// TikTok (tiktok.com) - Blocks (randomized) canvas data extraction before user input (+CanvasExtractionBeforeUserInputIsBlocked & +CanvasImageExtractionPrompt), as it doesn't need access and attempts to prompt users for it on desktop...
// TileMan.io (tileman.io) - Blocks (randomized) canvas data extraction before user input (+CanvasExtractionBeforeUserInputIsBlocked & +CanvasImageExtractionPrompt), as it doesn't need access and attempts to prompt users for it on desktop...
