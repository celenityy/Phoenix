...
zip -R archives/phoenix.zip 'configs/*' 'configs/ui-fix/*' 'etc/*' 'etc/profile.d/*' 'phoenix.cfg' 'policies.json' 'prefs/*' 'userjs/*' 'userjs/linux/*' 'userjs/linux/dev/*' 'userjs/linux/discord/*' 'userjs/linux/element/*' 'userjs/linux/hardened/*' 'userjs/linux/twitter/*' 'userjs/linux/ui-fix-base/*' 'userjs/linux/youtube/*' 'userjs/linux/ui-fix/dev/*' 'userjs/linux/ui-fix/discord/*' 'userjs/linux/ui-fix/element/*' 'userjs/linux/ui-fix/hardened/*' 'userjs/linux/ui-fix/twitter/*' 'userjs/linux/ui-fix/youtube/*' 'userjs/macos/*' 'userjs/macos/dev/*' 'userjs/macos/discord/*' 'userjs/macos/element/*' 'userjs/macos/hardened/*' 'userjs/macos/twitter/*' 'userjs/macos/ui-fix-base/*' 'userjs/macos/youtube/*' 'userjs/macos/ui-fix/dev/*' 'userjs/macos/ui-fix/discord/*' 'userjs/macos/ui-fix/element/*' 'userjs/macos/ui-fix/hardened/*' 'userjs/macos/ui-fix/twitter/*' 'userjs/macos/ui-fix/youtube/*' 'README.md' -x 'build/*' '.code-workspace' '.domains' '.DS_Store' '.git*' 'gitlab-ci.yml' 'legacy/*' '_redirects'
