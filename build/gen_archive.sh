...
zip -R archives/phoenix-osx.zip 'configs/*' 'configs/ui-fix/*' 'org.mozilla.nightly.plist' 'phoenix.cfg' 'userjs/*' 'userjs/macos/*' 'userjs/macos/discord/*' 'userjs/macos/element/*' 'userjs/macos/extended/*' 'userjs/macos/twitter/*' 'userjs/macos/ui-fix-base/*' 'userjs/macos/youtube/*' 'userjs/macos/ui-fix/discord/*' 'userjs/macos/ui-fix/element/*' 'userjs/macos/ui-fix/extended/*' 'userjs/macos/ui-fix/twitter/*' 'userjs/macos/ui-fix/youtube/*' 'COPYING' 'README.md' -x 'build/*' '.code-workspace' '.domains' '.DS_Store' '.git*' 'gitlab-ci.yml' '_redirects'
