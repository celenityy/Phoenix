...
pref("app.support.vendor", "Phoenix - Extended: {PHOENIX_VERSION}", locked); // [NO-MAIL] [HIDDEN]
...
pref("distribution.about", "Phoenix - Extended for Mozilla Firefox: {PHOENIX_VERSION} 💜", locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
